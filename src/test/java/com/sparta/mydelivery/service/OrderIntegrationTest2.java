...
class OrderIntegrationTest2 {
    ...
    void test1() throws JsonProcessingException {
        ...
        assertEquals(restaurantRequest.positionX, restaurantResponse.positionX);
        assertEquals(restaurantRequest.positionY, restaurantResponse.positionY);
    ...
    void test4() throws JsonProcessingException {
        ...
        // 배달비 확인
        assertEquals(3500, orderDto.deliveryFee);

        // 총 결제 금액 확인
        assertEquals(41900, orderDto.totalPrice);
    }
